const API_URL = "https://okxelz55n9.execute-api.us-east-1.amazonaws.com/dev";
const PHOTOGALLERY_S3_BUCKET_URL = "http://staticwebsite-dulaney-2024-4150.s3-website-us-east-1.amazonaws.com";
...
function uploadPhoto(){
    var title = $("#leagueID").val();
    var description = $("#leagueName").val();
    var tags = $("#tags").val();
    
    

    $.ajax({
        url: `${API_URL}/uploadleague/${filename}`,
        type: 'PUT',
        crossDomain: true,
...
function processAddPhoto(username, tags, leagueName){
